...
function ProcessPanel({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-primary px-6 py-10 md:px-14 md:py-14">
      ...
      <ol
        className="relative mt-10 grid w-fit max-w-full gap-x-6 sm:gap-x-8 md:mt-14 md:gap-x-10 [--process-gap:1.5rem] sm:[--process-gap:2rem] md:[--process-gap:2.5rem]"
      ...
      <div
        ref={timelineRef}
        aria-hidden="true"
        className="relative mt-6 grid h-3.5 w-fit max-w-full gap-x-6 sm:gap-x-8 md:gap-x-10 [--process-gap:1.5rem] sm:[--process-gap:2rem] md:[--process-gap:2.5rem]"
        style={{ gridTemplateColumns: gridColumns }}
      >
